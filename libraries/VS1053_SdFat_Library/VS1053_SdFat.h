...
#define VS1053_FILEPLAYER_PIN_INT                                              \
  3 //!< Allows useInterrupt to accept pins 0 to 4
...
public:
   ...
   */
  VS1053_SdFat(int8_t mosi, int8_t miso, int8_t clk, int8_t rst, int8_t cs,
   ...
   * @param dreq Data Request pin
   */
  VS1053_SdFat(int8_t rst, int8_t cs, int8_t dcs, int8_t dreq);
  /*!
 ...
 */
class VS1053_SdFat_FilePlayer : public VS1053_SdFat {
public:
  /*!
   ...
   */
  VS1053_SdFat_FilePlayer(int8_t mosi, int8_t miso, int8_t clk, int8_t rst,
   ...
   * @param cardCS CS pin for the SD card on the SPI bus
   */
  VS1053_SdFat_FilePlayer(int8_t rst, int8_t cs, int8_t dcs, int8_t dreq,
                             int8_t cardCS);
   ...
   * @param cardCS CS pin for the SD card on the SPI bus
   */
  VS1053_SdFat_FilePlayer(int8_t cs, int8_t dcs, int8_t dreq, int8_t cardCS);
